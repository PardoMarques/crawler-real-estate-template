...
if __name__ == "__main__":
    # 1. Executa o crawler
    os.system("scrapy crawl EvidenceImoveis -o data/EvidenceImoveis.json")

    # 2. Processa e transforma
    df_imovel, df_endereco, df_caracteristicas = processar_imoveis("data/EvidenceImoveis.json")
